...
# an attempt at decomposing with 3 cons, I'm not sure if I've done this correctly. Someone else needs to look at this.
...
#0.096 0.691 0.775 0.607 0.005 0.770
...
runtoequal_set <- function(State_int, M_C1_temp, M_C2_temp, M_C3_temp, P) {
...
runall <- function(sigma, rho, time) {
  ...
  C1_r_bar <- mean(C1_ldgr) - (mean(C2_resident_C1_invade)+mean(C3_resident_C1_invade))
  C2_r_bar <- mean(C2_ldgr) - (mean(C1_resident_C2_invade)+mean(C3_resident_C2_invade))
  C3_r_bar <- mean(C3_ldgr) - (mean(C1_resident_C3_invade)+mean(C2_resident_C3_invade))
  # ----------------------------------------------------------------------------------------------------
  ...
  # C1 as the invader
  State <-
    c(P = avg_predator_C1_invade_C2_resident_C3_resident,
      C1 = 0,
      C2 = 1,
      C3 = 1,
      R = 1) # starting parameters
  ...
  # C2 as the invader
  State <-
    c(P = avg_predator_C2_invade_C1_resident_C3_resident,
      C1 = 1,
      C2 = 0,
      C3 =1,
      R = 1) # starting parameters
  ...
  # C3 as the invader
  State <-
    c(P = avg_predator_C3_invade_C1_resident_C2_resident,
      C1 = 1,
      C2 = 1,
      C3 =0,
      R = 1) # starting parameters
  ...
  C1_delta_0 <- mean(C1_epsilon_0) - (mean(C2_resident_epsilon_0_invade_C1)+mean(C3_resident_epsilon_0_invade_C1))
  C2_delta_0 <- mean(C2_epsilon_0) - (mean(C1_resident_epsilon_0_invade_C2)+mean(C3_resident_epsilon_0_invade_C2))
  C3_delta_0 <- mean(C3_epsilon_0) - (mean(C1_resident_epsilon_0_invade_C3)+mean(C2_resident_epsilon_0_invade_C3))
  ...
  C1_delta_E <-
    mean(C1_epsilon_E) - (mean(C2_resident_epsilon_E_invade_C1)+mean(C3_resident_epsilon_E_invade_C1)) - C1_delta_0
  C2_delta_E <-
    mean(C2_epsilon_E) - (mean(C1_resident_epsilon_E_invade_C2)+mean(C3_resident_epsilon_E_invade_C2)) - C2_delta_0
  C3_delta_E <-
    mean(C3_epsilon_E) - (mean(C1_resident_epsilon_E_invade_C3)+mean(C2_resident_epsilon_E_invade_C3)) - C3_delta_0
  ...
  C1_delta_P <-
    mean(C1_epsilon_P) - (mean(C2_resident_epsilon_P_invade_C1)+mean(C3_resident_epsilon_P_invade_C1)) - C1_delta_0
  C2_delta_P <-
    mean(C2_epsilon_P) - (mean(C1_resident_epsilon_P_invade_C2)+mean(C3_resident_epsilon_E_invade_C2)) - C2_delta_0
  
  C3_delta_P <-
    mean(C3_epsilon_P) - (mean(C1_resident_epsilon_P_invade_C3)+mean(C1_resident_epsilon_E_invade_C3)) - C3_delta_0
...
write.csv(
  C1_final_mechanisms,
  file = here("C1_final_mechanisms_3con_pos_cor.csv"),
  row.names = FALSE
)
write.csv(
  C2_final_mechanisms,
  file = here("C2_final_mechanisms_3con_pos_cor.csv"),
  row.names = FALSE
)
write.csv(
  C3_final_mechanisms,
  file = here("C3_final_mechanisms_3con_pos_cor.csv"),
  row.names = FALSE
)
